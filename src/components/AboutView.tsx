  ...
  return (
    <div className="space-y-10 max-w-5xl mx-auto animate-fadeIn">
      ...
      <div className="bg-slate-800/80 rounded-xl p-6 border border-slate-700 shadow-sm space-y-4">
        ...
        <div className="bg-gradient-to-r from-blue-950/60 via-slate-900 to-indigo-950/60 p-4 rounded-xl border border-blue-500/30 flex flex-col gap-4 mt-4">
          ...
          <div className="pt-3 border-t border-slate-800/80 text-xs text-slate-400 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              ...
              To make the public link live for external evaluators, click the <strong>&quot;Share&quot;</strong> button in the top-right header of Google AI Studio.
            </div>
            <a
              href={ACADEMIC_PROJECT_INFO.devUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-400 hover:text-blue-300 underline inline-flex items-center gap-1 shrink-0"
            >
              <span>Open My Dev Preview Directly</span>
